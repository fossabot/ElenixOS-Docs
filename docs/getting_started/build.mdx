...
**解决方案**：安装 SDL2 开发库，详见[环境设置文档](/docs/getting_started/environment)。
...
1. 阅读[系统架构](/docs/architecture/arch)了解 ElenixOS 的设计
2. 阅读[快速开始](/docs/getting_started/quick_start)了解基本使用
3. 查阅 [JS API](/docs/js-api/index) 开始开发应用

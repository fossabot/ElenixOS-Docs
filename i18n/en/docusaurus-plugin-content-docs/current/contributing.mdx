...
This guide will help you understand the contribution process, coding standards, and contribution methods for ElenaOS, providing complete guidance for participating in ElenaOS development.
...
```bash
git clone https://github.com/your-username/ElenaOS.git
```
...
ElenaOS documentation is located in the `docs` directory and written in Markdown format.

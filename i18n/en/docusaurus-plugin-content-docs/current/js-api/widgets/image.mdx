...
Image is a special API component in ElenaOS for displaying images. This document will introduce the features, usage methods, and precautions of the image component.

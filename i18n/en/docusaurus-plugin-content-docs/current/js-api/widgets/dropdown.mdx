...
Dropdown is a special API component in ElenaOS for displaying and selecting dropdown options. This document will introduce the features, usage methods, and precautions of the dropdown component.

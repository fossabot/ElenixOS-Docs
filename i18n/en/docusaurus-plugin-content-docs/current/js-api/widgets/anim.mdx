...
Animation is a special API component in ElenaOS for creating and managing animation effects. This document will introduce the features, usage methods, and precautions of the animation component.
...
ElenaOS provides the following animation paths (easing functions):
...
Animation component is a special API component in ElenaOS for creating and managing animation effects. Through animation components, developers can add vivid visual effects to applications and improve user experience.

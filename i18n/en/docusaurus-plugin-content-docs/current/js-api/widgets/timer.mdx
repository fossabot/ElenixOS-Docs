...
Timer is a special API component in ElenaOS for creating and managing timers. This document will introduce the features, usage methods, and precautions of the timer component.

...
Calendar is a special API component in ElenaOS for displaying and selecting dates. This document will introduce the features, usage methods, and precautions of the calendar component.

...
Canvas is a special API component in ElenaOS for drawing graphics and images. This document will introduce the features, usage methods, and precautions of the canvas component.

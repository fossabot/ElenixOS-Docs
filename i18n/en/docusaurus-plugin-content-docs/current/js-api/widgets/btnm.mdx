...
Button Matrix is a special API component in ElenaOS for creating button matrices. This document will introduce the features, usage methods, and precautions of the button matrix component.
...
Button Matrix is a special API component in ElenaOS for creating button matrices. Through button matrix, developers can create keyboards, numeric keypads, function button groups, etc.

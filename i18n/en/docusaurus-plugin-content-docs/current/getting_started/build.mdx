...
1. Read [System Architecture](/docs/architecture/arch) to understand ElenixOS design
2. Read [Quick Start](/docs/getting_started/quick_start) to understand basic usage
3. Check [JS API](/docs/js-api/index) to start developing applications

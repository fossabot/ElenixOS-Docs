...
ElenaOS's watchfaces and applications are uniformly driven by Script Engine, which is based on [JerryScript](https://jerryscript.net) for compiling and executing JavaScript code.
...
The Script Engine is core module of ElenaOS, responsible for operation of watchfaces and applications.
...
3. **Automatic registration**: New `realm` will automatically register all functions and symbols, including LVGL UI API and ElenaOS system API

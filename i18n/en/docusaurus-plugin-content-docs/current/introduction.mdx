...
sidebar_position: 1
slug: /intro
title: Introduction to ElenixOS
---
...
1. [System Architecture](/docs/architecture/arch) to understand ElenixOS's layering.
...
5. For implementation details of core modules, consult [Core Modules](./architecture/framework/app/app).
